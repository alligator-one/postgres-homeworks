...
SELECT country, COUNT(*) as total FROM suppliers GROUP BY countryORDER BY total DESC
...
SELECT ship_region, ship_country, SUM(freight) FROM orders WHERE ship_region IS NOT NULL GROUP BY ship_region, ship_country
